...
Source0  : https://files.pythonhosted.org/packages/98/60/f174043244c5306c9988380d2cb10009f91563fc4b31293d27e17201af56/uritemplate-4.2.0.tar.gz
...
%prep
%setup -q -n uritemplate-4.2.0
cd %{_builddir}/uritemplate-4.2.0
pushd ..
cp -a uritemplate-4.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748897639
...
cp %{_builddir}/uritemplate-%{version}/LICENSE.APACHE %{buildroot}/usr/share/package-licenses/pypi-uritemplate/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/uritemplate-%{version}/LICENSE.BSD %{buildroot}/usr/share/package-licenses/pypi-uritemplate/7720cc454c495510106e04e6173b0e2fb94e077b || :
